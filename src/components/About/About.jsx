  ...
  return (
    <div className={s.about}>
      ...
      <div className={s.aboutText}>
        <p>
          Вітаю! Мене звати Карпова Оксана і я професіонал у сфері краси з понад
          5-річним досвідом. Я спеціалізуюся на манікюрі, педикюрі та догляді за
          бровами, і завжди прагну дарувати своїм клієнтам ідеальний вигляд та
          впевненість у собі.
        </p>
